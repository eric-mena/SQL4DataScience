...
-- as well as the code you used to arrive at your answer. You will be graded on how easy your code is to read, so remember to use proper formatting and comments where necessary.
...
-- You will be required to prepare the dataset for the analysis you choose to do. As with the first part, you will be graded, in part, 
...
-- where indicated into this worksheet so that your peers can review your work. You should be able to use any Text Editor (Windows Notepad, Apple TextEdit, Notepad ++, 
-- Sublime Text, etc.) to copy and paste your answers. If you are going to use Word or some other page layout application, just be careful to make sure your answers and 
...
-- ii. Hours.business_id = 2,052
-- iii. Category.business_id = 2,643
-- iv. Attribute.business_id = 1,115
-- v. Review.business_id = 8,090
-- vi. Checkin.business_id = 493
-- vii. Photo.business_id = 3,979
...
-- 7. Find the top 3 users based on their total number of reviews:
	...
	SELECT name, sum(review_count) reviews
	FROM user
	GROUP BY id
...
-- anomalies between them, predicting the overall star rating for a business, predicting the number of fans a user will have, and so on. These are just a few 
-- examples to get you started, so feel free to be creative and come up with your own problem you want to solve. Provide answers, in-line, to all of the following:
